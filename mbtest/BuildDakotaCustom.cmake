...
# cmake -D CMAKE_CXX_FLAGS="-fsanitize=address" \
# -D CMAKE_C_FLAGS="-fsanitize=address" \
# -D CMAKE_CXX_FLAGS=-isystem\ ~/lib \
# -C $DAK_SRC/cmake/BuildDakotaCustom.cmake $DAK_SRC

# cmake -C $DAK_SRC/cmake/BuildDakotaCustom.cmake $DAK_SRC

set(CMAKE_INCLUDE_DIRECTORIES_BEFORE ON)
include_directories(BEFORE "/private/mcbe/lib")

# set(CMAKE_SHARED_LINKER_FLAGS
# "${CMAKE_SHARED_LINKER_FLAGS} -Wl,-rpath -Wl,/private/mcbe/lib")

# set(CMAKE_EXE_LINKER_FLAGS
# "${CMAKE_EXE_LINKER_FLAGS} -Wl,-rpath -Wl,/private/mcbe/lib")

# set(CMAKE_STATIC_LINKER_FLAGS
# "${CMAKE_STATIC_LINKER_FLAGS} -Wl,-rpath -Wl,/private/mcbe/lib")
