...
set(BOOST_INCLUDEDIR
  "/home/bellout/git/EQN/downloads/boost_1_58_0_t0/boost"
  CACHE PATH "Use Boost installed here" FORCE)

set(BOOST_LIBRARYDIR
  "/home/bellout/git/EQN/downloads/boost_1_58_0_t0/stage/lib"
  CACHE PATH "Use Boost installed here" FORCE)
...
# export DAK_SRC="/home/bellout/git/EQN/everest-mbfork"
# export INSTALL="/home/bellout/git/EQN/packages"
# export PYTHON_LIBRARY="${DAK_SRC}/ev-env/lib/python3.10/site-packages/"
# export PYTHON_INCLUDE_DIR="${DAK_SRC}/ev-env/include/"
# export NUMARRAY_INCLUDE_DIR="${DAK_SRC}/ev-env/lib/python3.10"

set( PYTHON_LIBRARY "${PYTHON_LIBRARY}"
    CACHE PATH "Path to PYTHON_LIBRARY" FORCE )

set( PYTHON_INCLUDE_DIR "${PYTHON_INCLUDE_DIR}"
    CACHE PATH "Path to PYTHON_INCLUDE_DIR" FORCE )

set( PYTHON_NUMARRAY_INCLUDE_DIR "${PYTHON_NUMARRAY_INCLUDE_DIR}"
    CACHE PATH "Path to PYTHON_NUMARRAY_INCLUDE_DIR" FORCE )

set( BUILD_SHARED_LIBS ON
    CACHE BOOL "BUILD_SHARED_LIBS" FORCE)

set( DAKOTA_PYTHON ON
    CACHE BOOL "DAKOTA_PYTHON" FORCE)

set( DAKOTA_PYTHON_NUMPY ON
    CACHE BOOL "DAKOTA_PYTHON_NUMPY" FORCE)

set( DAKOTA_DLL_API OFF
    CACHE BOOL "DAKOTA_DLL_API" FORCE)

set( HAVE_X_GRAPHICS OFF
    CACHE BOOL "HAVE_X_GRAPHICS" FORCE)

set( DAKOTA_ENABLE_TPL_TESTS OFF
    CACHE BOOL "DAKOTA_ENABLE_TPL_TESTS" FORCE)
...
set( CMAKE_INSTALL_PREFIX "${INSTALL}"
    CACHE PATH "Path to CMAKE_INSTALL_PREFIX" FORCE )

set( DAKOTA_NO_FIND_TRILINOS:BOOL TRUE
    CACHE BOOL "DAKOTA_NO_FIND_TRILINOS" FORCE)
